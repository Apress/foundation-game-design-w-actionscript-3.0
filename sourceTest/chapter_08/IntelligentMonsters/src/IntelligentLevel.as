package
{
	...
	public class IntelligentLevel extends Sprite
	{
		...
		public function IntelligentLevel(stage:Object)
		{
			_stage = stage;	
		...
		private function changeMonsterDirection(monster:Monster):void
		{
			...
			var xDistance = Math.abs(_character.x - monster.x);
			var yDistance = Math.abs(_character.y - monster.y);
